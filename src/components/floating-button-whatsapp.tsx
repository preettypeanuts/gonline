...
export const handleWhatsApp = () => {
  const wa = dataContact.find((c) => c.label === "WhatsApp");
  window.open(
    wa?.link ?? whatsappUrl("Halo GONLINE, saya ingin bertanya."),
    "_blank",
  );
};
    ...
    <>
      <div className="hidden md:block z-100">
        <button
          ...
          className="aspect-square bg-black dark:bg-white text-green-400 dark:text-[#31c529] hover:bg-secondaryDark dark:hover:bg-secondaryLight active:scale-95 duration-300 ease-in-out p-3 rounded-full cursor-pointer flex items-center justify-center"
        >
          <svg
