    ...
    return (
        <section className="spacing">
            ...
            <div className="flex md:flex-row flex-col gap-3 md:pr-10 pr-4">
                <div className="left-padding rounded-r-3xl bg-darkColor text-white dark:bg-lightColor dark:text-black py-10 pr-10 flex flex-col justify-between relative">
                ...
                <div className="flex flex-row gap-3 right-padding">
                    {items.map((item, index) => (
                        <div
                            key={index}
                            className={`min-w-50! relative overflow-hidden min-h-100 hover:min-w-120 md:min-w-0 ease-in-out bg-white dark:bg-neutral-900 rounded-main p-8 border border-neutral-200 dark:border-neutral-800 hover:shadow-xl transition-all duration-500 flex flex-col justify-between`}
                        >
