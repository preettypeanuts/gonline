            ...
            <section className=" spacing">
                <div className="relative">
                    <Image
                        width={700}
                        height={700}
                        className="w-full h-[70lvh] object-cover rounded-"
                        ...
                        alt=""
                    />
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 bg-lightColor rounded-t-3xl px-3 pt-3 w-full max-w-4xl text-center">
                        ...
                        <div className="bg-white dark:bg-darkColor rounded-2xl px-8 py-10 text-center">
