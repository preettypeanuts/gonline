        ...
        <main className="spacing">
            ...
            <section className="mb-20">
                <div className="flex flex-row gap-4 md:me-10">
                    ...
                    <div className="flex items-center left-padding pr-5 py-5 bg-darkColor text-white dark:bg-lightColor dark:text-black rounded-r-3xl font-bold text-2xl md:text-4xl relative shrink-0">
                        Vision
                    ...
                    <h2 className="font-medium text-base md:text-3xl px-4 md:px-5 py-3 bg-white dark:bg-black rounded-main right-margin">
            ...
            <section>
                <div className="flex flex-row w-full gap-3">
                    ...
                    <div className="flex flex-wrap justify-end gap-3 left-margin">
                        <p className="font-medium text-sm md:text-lg px-4 md:px-5 py-3 bg-white dark:bg-black rounded-main">
                    ...
                    <div className="flex items-center right-padding pl-5 py-5 bg-darkColor text-white dark:bg-lightColor dark:text-black rounded-l-3xl font-bold text-2xl md:text-4xl relative shrink-0">
                        Mission
