...
const navItems = [
    ...
    { label: "Services", icon: IconService },
...
const serviceItems: ServiceItem[] = [
    ...
    {
        title: "GO Analytics",
        description: "Data insights and performance tracking for your brand.",
        icon: BarChart3,
        href: "/analytics",
    },
];
...
export const BottomNav = () => {
    ...
    return (
        <div className="fixed left-4 right-4 bottom-4 z-50 md:hidden">
            <nav className={`
                flex flex-col items-center px-1.5 py-1.5 rounded-main overflow-hidden border border-neutral-300/20 shadow-mainShadow
                ...
                >
                    <div style={{ overflow: "hidden" }}>
                        <div className="grid grid-cols-2 gap-2 pb-1 mb-10">
                            {serviceItems.map((item, index) => (
                                <Link
                                    key={index}
                                    href={item.href}
                                    onClick={() => setServiceOpen(false)}
                                    className="flex flex-col gap-2 p-3 rounded-xl group"
                                    style={{
