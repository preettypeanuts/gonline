        ...
        <div className="relative flex items-center">
          ...
          <div
            ...
            className={`
                            ...
                            ${pills.length > 3 ? "max-w-83.5 md:max-w-200" : ""}
                        `}
          >
            {pills.map((cat) => {
              const catId = cat.id === "all" ? null : cat.id
              const isActive =
              ...
              return (
                <button
                  key={cat.id}
                  type="button"
                  onClick={() => updateParams({ category: catId })}
                  className={`
            ...
            <button
              type="button"
              onClick={() =>
                updateParams({ highlight: activeHighlight ? null : "true" })
              }
              className={`
                                h-11 px-5 rounded-full text-xs uppercase font-bold shrink-0
                                transition-all duration-300 cursor-pointer
